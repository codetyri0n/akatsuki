return {
  ...
  config = function()
    ...
    require("mason-lspconfig").setup({
      ensure_installed = vim.tbl_keys(require("leconfig.plugins.lsp.servers")),
    })
    ...
    mason_lspconfig.setup_handlers({
      function(server_name)
        require("lspconfig")[server_name].setup({
          ...
          settings = require("leconfig.plugins.lsp.servers")[server_name],
          filetypes = (require("leconfig.plugins.lsp.servers")[server_name] or {}).filetypes,
        })
      end,
    })
